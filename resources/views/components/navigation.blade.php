<div>
    <div class="sticky top-0 z-10 flex flex-shrink-0 h-16 bg-gray-800 shadow dark:bg-gray-800 dark:border-gray-700">
        <button @click="menuVisibility=true;" type="button"
            ...
            <div class="flex items-center ml-4 md:ml-6">
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-dropdown align="right" width="48" contentClasses="bg-gray-800">
                        <x-slot name="trigger">
                            <button
                                class="inline-flex items-center px-3 py-2 text-sm font-medium leading-4 text-white transition duration-150 ease-in-out bg-gray-800 border border-transparent rounded-md dark:text-gray-400 dark:bg-gray-800 hover:dark:hover:text-gray-9500 focus:outline-none">
